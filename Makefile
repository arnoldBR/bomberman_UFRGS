...
# Aqui estamos scaneando o SRC_DIR para achar os codigos fonte para achar os .c
# e usando estes para definir os .o
SRC = $(wildcard $(SRC_DIR)/*.c)#$(call rwildcard, *.c, *.h) - pega os sourcefiles do SRC_DIR
